...
namespace RE
{
	...
	public:
		...
		struct RuntimeInfo
		{
			std::int32_t sizeOfExternalRuntime;
		...
		virtual std::uint8_t     GetNotifiedBodyIndex() const;                                                                                              // 09
		...
		virtual void             RemoveInstance(hkpConstraintInstance* a_constraint, hkpConstraintRuntime* a_runtime, std::int32_t a_sizeOfRuntime) const;  // 0F
