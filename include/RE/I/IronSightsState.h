...
namespace RE
{
	class IronSightsState :
		public TESCameraState  // 00
	{
	public:
		inline static constexpr auto RTTI = RTTI_IronSightsState;
		inline static constexpr auto VTABLE = VTABLE_IronSightsState;

		~IronSightsState() override;  // 00
