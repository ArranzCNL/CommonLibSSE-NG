...
#define RUNTIME_DATA_CONTENT                                                                      \
			...
			RenderTargetData     renderTargets[RENDER_TARGET::kTOTAL];  /* 0A60 */
#else
#define RUNTIME_DATA_CONTENT                                                                       \
			...
			RenderTargetData     renderTargets[RENDER_TARGET::kVRTOTAL]; /* 0A58 */
#endif
...
#elif !defined(ENABLE_SKYRIM_AE) && !defined(ENABLE_SKYRIM_SE)
		static_assert(sizeof(Renderer) == 0x21B8);
#else
		static_assert(sizeof(Renderer) == 0x1FB0);
#endif
	}
