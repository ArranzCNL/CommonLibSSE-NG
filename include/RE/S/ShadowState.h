...
#define FLAT_RUNTIME_DATA_CONTENT                                                                                                                            \
				...
				std::uint32_t              PSResourceModifiedBits;                                      /* 04 Flags +0x4  0xFFFF */                           \
				std::uint32_t              PSSamplerModifiedBits;                                       /* 08 Flags +0x8  0xFFFF */                           \
				std::uint32_t              CSResourceModifiedBits;                                      /* 0c Flags +0xC  0xFFFF */                           \
				std::uint32_t              CSSamplerModifiedBits;                                       /* 10 Flags +0x10 0xFFFF */                           \
				std::uint32_t              CSUAVModifiedBits;                                           /* 14 Flags +0x14 0xFF */                             \
				std::uint32_t              renderTargets[D3D11_SIMULTANEOUS_RENDER_TARGET_COUNT];       /* 18, VR 20 */                                       \
				std::uint32_t              depthStencil;                                                /* 38, VR 40 - Index */                               \
				std::uint32_t              depthStencilSlice;                                           /* 3c, VR 44 Index */                                 \
				std::uint32_t              cubeMapRenderTarget;                                         /* 40, VR 48 = Index */                               \
				std::uint32_t              cubeMapRenderTargetView;                                     /* 44, VR 4c Index */                                 \
				...
				std::uint32_t              depthStencilStencilMode;                                     /* 90, VR 98 */                                       \
				std::uint32_t              stencilRef;                                                  /* 94, VR 9c */                                       \
				std::uint32_t              rasterStateFillMode;                                         /* 98, VR a0 */                                       \
				std::uint32_t              rasterStateCullMode;                                         /* 9c, VR a4 */                                       \
				std::uint32_t              rasterStateDepthBiasMode;                                    /* a0, VR a8 */                                       \
				std::uint32_t              rasterStateScissorMode;                                      /* a4, VR ac */                                       \
				std::uint32_t              alphaBlendMode;                                              /* a8, VR b0 */                                       \
				std::uint32_t              alphaBlendAlphaToCoverage;                                   /* ac, VR b4 */                                       \
				std::uint32_t              alphaBlendWriteMode;                                         /* b0, VR b8 */                                       \
				bool                       alphaTestEnabled;                                            /* b4, VR BC */                                       \
				float                      alphaTestRef;                                                /* b8, VR C0 */                                       \
				std::uint32_t              PSTextureAddressMode[16];                                    /* bc, VR c4 */                                       \
				std::uint32_t              PSTextureFilterMode[16];                                     /* fc, VR 104 */                                      \
				ID3D11ShaderResourceView*  PSTexture[16];                                               /* 140, VR 148 */                                     \
				std::uint32_t              CSTextureAddressMode[16];                                    /* 1c0, VR 1c8 */                                     \
				std::uint32_t              CSTextureFilterMode[16];                                     /* 200, VR 208 */                                     \
				ID3D11ShaderResourceView*  CSTexture[16];                                               /* 240, VR 248 */                                     \
				std::uint32_t              CSTextureMinLodMode[16];                                     /* 2c0, VR 2C8 */                                     \
				ID3D11UnorderedAccessView* CSUAV[8];                                                    /* 300, VR 308 */                                     \
				std::uint64_t              vertexDesc;                                                  /* 340, VR 388 only? */                               \
				...
				std::uint32_t              alphaBlendModeExtra;                                         /* 5d0, VR 880 */                                     \
				float                      unk5c8;                                                      /* 5d4, VR 884 */                                     \
				float                      unk5cc;                                                      /* 5d8 VR 888 */                                      \
				std::uint32_t              unk5d0;                                                      /* 5dc VR 88c */
...
#define VR_RUNTIME_DATA_CONTENT                                                                                                                              \
				...
				std::uint32_t              CSSamplerModifiedBits;                                       /* 10 Flags +0x10 0xFFFF */                           \
				std::uint32_t              CSUAVModifiedBits;                                           /* 14 Flags +0x14 0xFF */                             \
				std::uint32_t              OMUAVModifiedBits;                                           /* 18 Flags +0x18 0xFF VR Only  */                    \
				std::uint32_t              SRVModifiedBits;                                             /* 1c Flags +0x1C 0xFF VR Only  */                    \
				std::uint32_t              renderTargets[D3D11_SIMULTANEOUS_RENDER_TARGET_COUNT];       /* 18, VR 20 */                                       \
				std::uint32_t              depthStencil;                                                /* 38, VR 40 - Index */                               \
				std::uint32_t              depthStencilSlice;                                           /* 3c, VR 44 Index */                                 \
				std::uint32_t              cubeMapRenderTarget;                                         /* 40, VR 48 = Index */                               \
				...
				std::uint32_t              CSTextureMinLodMode[16];                                     /* 2c0, VR 2C8 */                                     \
				ID3D11UnorderedAccessView* CSUAV[8];                                                    /* 300, VR 308 */                                     \
				std::uint8_t               unk348[0x388 - 0x348];                                       /* VR 348 */                                          \
				std::uint64_t              vertexDesc;                                                  /* 340, VR 388 only? */                               \
				VertexShader*              currentVertexShader;                                         /* 348, VR 390 */                                     \
				PixelShader*               currentPixelShader;                                          /* 350, VR 398 */                                     \
				D3D11_PRIMITIVE_TOPOLOGY   topology;                                                    /* 358, VR 3A0 */                                     \
				...
				std::uint8_t               unk3d4[0x3e0 - 0x3d4];                                       /* 3d4, VR only pad */                                \
